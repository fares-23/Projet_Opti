...
\begin{document}
    ...
    \section*{Algorithme NSGA-II}\addcontentsline{toc}{section}{Algorithme NSGA-II}
        ...
        Comme affiché sur la figure \ref{fig:NSGA2}, les solutions intéressantes pour notre batterie semblent se trouver aux alentours de $1$ ou $2$~kWh, pour un seuil vers les $275$~kW et une chute de $225$~V (le points rouges représentant la dernière génération créée par notre algorithme).
