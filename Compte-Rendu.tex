...
\begin{document}
    ...
    \section*{Conclusion}\addcontentsline{toc}{section}{Conclusion}
        ...
        \begin{figure}[H]
            ...
            \caption{Résultats de la simulation du train, pour une batterie de capacité $1,5$~kWh et un seuil de $300$~kW (paramètres optimisés selon l'algorithme NSGA-II).}
            \label{fig:Con}
        \end{figure}
